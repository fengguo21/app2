<template>
    <yd-popup v-model="param.show" position="bottom" height="90%">
        <div class="titleBar">
            <div class="title">
                客户详情
            </div>
        ...
        <yd-accordion accordion>
            <yd-accordion-item title="商品信息" open>
            ...
            <yd-accordion-item title="分期信息" open>
                <div style="padding: .24rem;">
                    <yd-list theme="1" slot="list">
        ...
        <yd-button type="primary" size="large" @click.native="createOrder">提交</yd-button>
...
export default {
    ...
    data() {
        return {
            ...
            //商品信息
            goodsList: this.param.goodsList,
            //分期信息
            stageList: [],
            show: {
                slideBar: false,
    ...
    methods: {
        ...
        createOrder() {
            ...
            let body = {
                ...
                biz_method: "addBuyOrderByOrderLink",
                biz_param: {
